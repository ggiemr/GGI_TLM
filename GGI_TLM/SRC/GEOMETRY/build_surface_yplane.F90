...
!
!SUBROUTINE build_surface_yplane
!
! NAME
!     SUBROUTINE build_surface_yplane
!
! DESCRIPTION
!     build_surface_yplane:
!
!     create a triangulated yplane surface
!     
! COMMENTS
!     
!
...
!
!
SUBROUTINE build_surface_yplane(surface_number)
...
9000 CALL write_line('Error in build_surface_yplane:',0,.TRUE.)
     CALL write_line('y1.NE.y2',0,.TRUE.)
     CALL write_line_real('y1=',y1,0,.TRUE.)
     CALL write_line_real('y2=',y2,0,.TRUE.)
     STOP


END SUBROUTINE build_surface_yplane
