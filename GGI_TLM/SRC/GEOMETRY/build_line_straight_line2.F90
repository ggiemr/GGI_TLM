...
!
!SUBROUTINE build_line_straight_line2
!
! NAME
!     SUBROUTINE build_line_straight_line2
!
! DESCRIPTION
!     build_line_straight_line2:
!
...
!
!
SUBROUTINE build_line_straight_line2(line_number)
...
! CREATE A LINE SEGMENT DEFINED BY LINE LENGTH AND TRANSFORMATION
      ...
      xmin=problem_lines(line_number)%line_parameters(1)
      ymin=problem_lines(line_number)%line_parameters(2)
      zmin=problem_lines(line_number)%line_parameters(3)
      xmax=problem_lines(line_number)%line_parameters(4)
      ymax=problem_lines(line_number)%line_parameters(5)
      zmax=problem_lines(line_number)%line_parameters(6)
...
END SUBROUTINE build_line_straight_line2
