...
!
!SUBROUTINE build_volume_rectangular_block2
!
! NAME
!     SUBROUTINE build_volume_rectangular_block2
!
! DESCRIPTION
!     build_volume_rectangular_block2:
!
!     create a triangulated rectangular block2 volume
!     
! COMMENTS
!     
!
...
!
!
SUBROUTINE build_volume_rectangular_block2(volume_number)
...
! create rectangular_block vertices
      x1=problem_volumes(volume_number)%volume_parameters(1)
      y1=problem_volumes(volume_number)%volume_parameters(2)
      z1=problem_volumes(volume_number)%volume_parameters(3)
      x2=problem_volumes(volume_number)%volume_parameters(4)
      y2=problem_volumes(volume_number)%volume_parameters(5)
      z2=problem_volumes(volume_number)%volume_parameters(6)
...
END SUBROUTINE build_volume_rectangular_block2
