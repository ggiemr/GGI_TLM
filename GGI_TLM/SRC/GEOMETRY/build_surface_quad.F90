...
!     build_surface_quad:
!
!     create a triangulated quad surface
!     
! COMMENTS
!     
!
...
!
!
SUBROUTINE build_surface_quad(surface_number)
...
type(xyz)	:: point1,point2,point3,point4,point5
...
! create rectangular_block vertices
      ...
      x3=problem_surfaces(surface_number)%surface_parameters(7)
      y3=problem_surfaces(surface_number)%surface_parameters(8)
      z3=problem_surfaces(surface_number)%surface_parameters(9)
      x4=problem_surfaces(surface_number)%surface_parameters(10)
      y4=problem_surfaces(surface_number)%surface_parameters(11)
      z4=problem_surfaces(surface_number)%surface_parameters(12)
      ...
      point4%y=y4
      point4%z=z4
      point5%x=(x1+x2+x3+x4)/4d0
      point5%y=(y1+y2+y3+y4)/4d0
      point5%z=(z1+z2+z3+z4)/4d0
...
! set triangles to make the normal point outwards	  
      ...
      problem_surfaces(surface_number)%triangle_list(triangle_count)%vertex(3)=point1
      ...
      triangle_count=triangle_count+1
      problem_surfaces(surface_number)%triangle_list(triangle_count)%vertex(1)=point5
      problem_surfaces(surface_number)%triangle_list(triangle_count)%vertex(2)=point1
      problem_surfaces(surface_number)%triangle_list(triangle_count)%vertex(3)=point4

  RETURN

END SUBROUTINE build_surface_quad
