...
!
!SUBROUTINE build_surface_zplane
!
! NAME
!     SUBROUTINE build_surface_zplane
!
! DESCRIPTION
!     build_surface_zplane:
!
!     create a triangulated zplane surface
!     
! COMMENTS
!     
!
...
!
!
SUBROUTINE build_surface_zplane(surface_number)
...
9000 CALL write_line('Error in build_surface_zplane:',0,.TRUE.)
     CALL write_line('z1.NE.z2',0,.TRUE.)
     CALL write_line_real('z1=',z1,0,.TRUE.)
     CALL write_line_real('z2=',z2,0,.TRUE.)
     STOP


END SUBROUTINE build_surface_zplane
