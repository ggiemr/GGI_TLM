...
!
!SUBROUTINE build_surface_circle
!
! NAME
!     SUBROUTINE build_surface_circle
!
! DESCRIPTION
!     build_surface_circle:
!
!     create a triangulated circle surface
!     
! COMMENTS
!     
!
...
!
!
SUBROUTINE build_surface_circle(surface_number)
...
! CREATE A TRIANGULATED CIRCLE MESH ON THE SCALE OF DL.    
...
! get point1 at the centre of the circle surface
	point1%x=0d0
	point1%y=0d0
	point1%z=0d0
	  
! get points 2 and 3 on the circumference of the circle
	CALL rphiz_to_xyz_point(radius,phi1,0d0,point2)
	CALL rphiz_to_xyz_point(radius,phi2,0d0,point3)
...
END SUBROUTINE build_surface_circle
