...
!
!SUBROUTINE build_volume_pyramid
!
! NAME
!     SUBROUTINE build_volume_pyramid
!
! DESCRIPTION
!     build_volume_pyramid:
!
!     create a pyramid volume from two tets
!     
! COMMENTS
!     
!
! HISTORY
!
!     started 26/04/2013 CJS
!
!
SUBROUTINE build_volume_pyramid(volume_number)
...
real*8  :: height,half_side_length
...
END SUBROUTINE build_volume_pyramid
