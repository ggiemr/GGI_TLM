...
!
!SUBROUTINE build_surface_hemisphere
!
! NAME
!     SUBROUTINE build_surface_hemisphere
!
! DESCRIPTION
!     build_surface_hemisphere:
!
!     create a triangulated hemisphere surface
!     
! COMMENTS
!     
!
! HISTORY
!
!     started 24/02/2014 CJS
!
!
SUBROUTINE build_surface_hemisphere(surface_number)
...
! we have at least 12 edges around the circumference
      ...
      n_circumference=4*NINT(circumference/(2d0*dl))  ! ensure that n_circumference is a multiple of 4
      
      if (n_circumference.lt.12) n_circumference=12
      
      n_theta=n_circumference/4
      n_phi=n_circumference
      
      dtheta=0.5d0*pi/n_theta
      dphi=2d0*pi/n_phi
...
END SUBROUTINE build_surface_hemisphere
