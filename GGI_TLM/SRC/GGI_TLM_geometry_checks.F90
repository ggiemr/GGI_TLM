...
! START
  ...
  write(*,*)'GGI_TLM_geometry_checks'
  
  CALL write_progress('STARTED: GGI_TLM_geometry_checks')
  
  CALL write_line('GGI_TLM_geometry_checks',0,output_to_screen_flag)
...
! FINISH
  ...
  CALL write_progress('FINISHED: GGI_TLM_geometry_checks')

  CALL write_line('FINISHED: GGI_TLM_geometry_checks',0,output_to_screen_flag)
  
END PROGRAM GGI_TLM_geometry_checks
