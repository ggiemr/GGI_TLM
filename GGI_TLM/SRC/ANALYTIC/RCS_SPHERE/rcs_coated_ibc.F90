...
!       
       ...
       subroutine rcs_coated_ibc(theta,phi,w,a1,a2,eps2,mu2,		&
...
! Equations from Ephi, Htheta set
	 k3b=(-beta0/(j*w*w*mu0*eps0))*sp_dbesselH2_beta0_a2(n)	&
            -z11*(-1D0/(w*mu0))*sp_besselH2_beta0_a2(n)	
      
	 k3d=-z12*(-1D0/(w*mu2))*sp_besselH1_beta2_a2(n)
	 k3e=-z12*(-1D0/(w*mu2))*sp_besselH2_beta2_a2(n)
	 
	 k4c=(1D0/(w*eps0*z0))*sp_besselH2_beta0_a2(n)	&
             -z11*(beta0/(j*w*w*mu0*eps0*z0))*sp_dbesselH2_beta0_a2(n)	 
     
	 k4f=-z12*(beta2/(j*w*w*mu2*eps2*z2))*sp_dbesselH1_beta2_a2(n)
	 k4g=-z12*(beta2/(j*w*w*mu2*eps2*z2))*sp_dbesselH2_beta2_a2(n)
	 
	 k5b=-z21*(-1D0/(w*mu0))*sp_besselH2_beta0_a2(n)
	 
	 k5d=(-beta2/(j*w*w*mu2*eps2))*sp_dbesselH1_beta2_a2(n)	&
              -z22*(-1D0/(w*mu2))*sp_besselH1_beta2_a2(n)
	 k5e=(-beta2/(j*w*w*mu2*eps2))*sp_dbesselH2_beta2_a2(n)	&
              -z22*(-1D0/(w*mu2))*sp_besselH2_beta2_a2(n)
	 
	 k6c=-z21*( beta0/(j*w*w*mu0*eps0*z0))*sp_dbesselH2_beta0_a2(n)	
	  
	 k6f= (+1D0/(w*eps2*z2))*sp_besselH1_beta2_a2(n)	&
     	 -z22*(beta2/(j*w*w*mu2*eps2*z2))*sp_dbesselH1_beta2_a2(n)	 
	 k6g= (+1D0/(w*eps2*z2))*sp_besselH2_beta2_a2(n)	&
     	 -z22*(beta2/(j*w*w*mu2*eps2*z2))*sp_dbesselH2_beta2_a2(n)

! RHS elements for solution of field expansion coefficients

         r3=-( an*(-beta0/(j*w*w*mu0*eps0))*sp_dbesselJ_beta0_a2(n)	&
              -z11*an*(-1D0/(w*mu0))*sp_besselJ_beta0_a2(n) )
     
	 r4=-( an*(1D0/(w*eps0*z0))*sp_besselJ_beta0_a2(n)	&
              -z11*an*(beta0/(j*w*w*mu0*eps0*z0))*sp_dbesselJ_beta0_a2(n) )
	 
	 r5=-( an*(-z21)*(-1D0/(w*mu0))*sp_besselJ_beta0_a2(n)  )
...
! near field expression: field on outside of cylinder
         ...
         Ethetao=Ethetao-(beta0/(j*w*w*mu0*eps0*a2))*cos(phi)*		&
