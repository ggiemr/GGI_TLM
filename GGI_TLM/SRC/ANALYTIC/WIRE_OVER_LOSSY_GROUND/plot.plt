...
#set xrange[1e4:1e7]
#set yrange[0:4]
plot 'Carson_wire_over_lossy_ground.out' u 1:2 title 'Re{gamma} (Carson)' w l,\
...
plot 'k0.out' u 1:2 title 'k0' w l,\
     'Carson_wire_over_lossy_ground.out' u 1:3 title 'Im{gamma} (Carson)' w l,\
...
set autoscale y
#set yrange[-150:0.0]
plot 'Carson_wire_over_lossy_ground.out' u 1:4 title 'attenuation over 1km (Carson)' w l,\
