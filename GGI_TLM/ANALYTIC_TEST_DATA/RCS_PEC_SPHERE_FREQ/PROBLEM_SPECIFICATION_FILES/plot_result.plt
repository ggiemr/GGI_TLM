...
#OUTPUT_TO_FILE set output "Test_case_2_RCS_sphere_freq_epsr.jpg"
...
#OUTPUT_TO_FILE set output "Test_case_2_RCS_sphere_freq_mur.jpg"
set xlabel "Frequency(Hz)"
...
#OUTPUT_TO_FILE set output "Test_case_2_RCS_sphere_freq_rcs.jpg"
set xlabel "Frequency(Hz)"
set ylabel "RCS (dBsm)"
