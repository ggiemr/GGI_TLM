...
plot "PROBLEM_SPECIFICATION_FILES/S21.fout_4_ref" u 1:5 title "  |S11|: GGI_TLM reference" w p,\
     "PROBLEM_SPECIFICATION_FILES/S21.fout_4_ref" u 1:9 title "  |S21|: GGI_TLM reference" w p,\
