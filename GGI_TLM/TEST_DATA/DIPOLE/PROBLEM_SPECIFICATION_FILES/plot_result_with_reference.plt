...
plot "PROBLEM_SPECIFICATION_FILES/dipole.field.tout_ref" u 1:3 title "Dipole field: GGI_TLM Reference" w p ,\
...
plot "PROBLEM_SPECIFICATION_FILES/dipole.cable_current.tout_ref" u 1:3 title "Dipole current: GGI_TLM Reference" w p ,\
...
plot "PROBLEM_SPECIFICATION_FILES/dipole.impedance.fout_ref" u 1:3 title "Re{Z}: GGI_TLM Reference " w p,\
