...
set xlabel "Time (s)"
set ylabel "A"
plot "PROBLEM_SPECIFICATION_FILES/coax_monopole.cable_current.tout_ref" u 1:3 title "Coax monopole current: GGI_TLM Reference" w p ,\
...
set xlabel "Time (s)"
set ylabel "V/m"
plot "PROBLEM_SPECIFICATION_FILES/coax_monopole.field.tout_ref" u 1:3 title "Coax monopole field: GGI_TLM Reference" w p ,\
