...
#OUTPUT_TO_FILE set output "Test_case_39_TCS_MODE_STIR_field.jpg"
set xlabel "Time (s)"
set ylabel "V/m"
...
#OUTPUT_TO_FILE set output "Test_case_39_TCS_MODE_STIR_freq_field.jpg"
...
#OUTPUT_TO_FILE set output "Test_case_39_TCS_MODE_STIR_power.jpg"
set xlabel "Frequency (Hz)"
set ylabel "W"
...
#OUTPUT_TO_FILE set output "Test_case_39_TCS_MODE_STIR_power_dB.jpg"
set xlabel "Frequency (Hz)"
set ylabel "dB"
...
#OUTPUT_TO_FILE set output "Test_case_39_TCS_MODE_STIR_TCS.jpg"
set xlabel "Frequency (Hz)"
set ylabel "Transmission Cross Section dB square metres"
plot "TCS.fout" u 1:7 title "GGI_TLM" w l,\
"TCS_volume_average.fout" u 1:7 title "GGI_TLM volume average" w l,\
"TCS_freq_stir.fout" u 1:7 title "GGI_TLM freq_stir" w l,\
"TCS_volume_average_freq_stir.fout" u 1:7 title "GGI_TLM volume average freq_stir" w l
#PAUSE pause -1
