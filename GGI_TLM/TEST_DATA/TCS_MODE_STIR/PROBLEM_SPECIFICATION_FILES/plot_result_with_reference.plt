...
plot "PROBLEM_SPECIFICATION_FILES/TCS.fout_ref" u 1:7 title "Transmission cross section: GGI_TLM reference" w p,\
"TCS.fout" u 1:7 title "Transmission cross section: GGI_TLM" w l
