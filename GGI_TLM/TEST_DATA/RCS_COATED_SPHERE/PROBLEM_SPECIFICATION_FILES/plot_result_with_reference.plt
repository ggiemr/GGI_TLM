...
#OUTPUT_TO_FILE set output "Test_case_48_RCS_COATED_far_field_ref.jpg"
set autoscale x
set autoscale y
set xlabel "Time (s)"
...
#OUTPUT_TO_FILE set output "Test_case_48_RCS_COATED_rcs_ref.jpg"
set autoscale x
set autoscale y
...
plot "sphere.rcs.fout" u 1:5 title "GGI_TLM" w l,\
     ...
     "PROBLEM_SPECIFICATION_FILES/coated.rcs_ref" u 1:4 title "Analytic result" w p
#PAUSE pause -1
