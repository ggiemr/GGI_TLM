...
set xlabel "Time (s)"
set ylabel "V/m"
plot  "PROBLEM_SPECIFICATION_FILES/SAR_test.field.tout_ref" u 1:3 title "SAR test field: GGI_TLM Reference" w p ,\
...
set ylabel "SAR (W/kg)"
plot "PROBLEM_SPECIFICATION_FILES/SAR_test.SAR.fout_ref" u 2:3 title "SAR : GGI_TLM Reference" w p ,\
